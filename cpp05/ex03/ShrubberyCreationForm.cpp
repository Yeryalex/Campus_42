...
void	ShrubberyCreationForm::fileCreation(Bureaucrat const &target) const {
...
"           \\\\/ ._\\//_/__/  ,\\_//__\\\\/.  \\_//__/_\n";
	...
	std::string result = target.getName() + "_shrubbery";
	std::ofstream	_file;
...
const char*	ShrubberyCreationForm::FormNotSigned::what() const throw() {
	...
	return ("your grade to sign ShrubberyCreationForm was lower that the required by the form!");
}

const char*	ShrubberyCreationForm::FormNotAbleToExecute::what() const throw() {
	
	return ("your grade to execute ShrubberyCreationForm was lower that the required by the form!");
}
